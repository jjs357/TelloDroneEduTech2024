...
#    user_input = input(question)
    user_input = input(f"Hit return to submit your question: {question}")
    if user_input.lower() in ['exit', 'quit', 'bye']:
        return

    response = chat.send_message(message="Answer either 'yes' or 'no'. Do not use any other words." + question)
